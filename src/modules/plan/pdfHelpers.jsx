...
// ============================================================================
// PDF GENERATION CONSTANTS (from original)
// ============================================================================
...
// NESTING PDF HELPERS
// ============================================================================
export const nestPdfLabel = (doc, px, py, pw, ph, num, dim, fc, sc) => {
...
export const nestPdfCell = (doc, layout, cX, cY, cW, cH, total) => {
...
export const nestDrawRmTable = (doc, reqs, title, startY = 30, PW = 297, PH = 210, M = 6) => {
...
export const nestBuildPages = (doc, nd) => {
...
// Helper to compute RM requirement from nesting data
export const nestComputeRmReq = ndArray => {
    const map = new Map();
...
// ============================================================================
// MAIN PLAN PDF BUILDER
// ============================================================================
export const buildPlanPDF = (planNo, planDataObj, nestingData = null) => {
    ...
    // ---- Nesting Pages (if nestingData provided) ----
    if (nestingData) {
        nestBuildPages(doc, nestingData);
    }
