...
Reference full template: `E:/PPCPLAN/FORMO/Formo/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/PPCPLAN/FORMO/Formo/.gemini/get-shit-done/templates/state.md`.
